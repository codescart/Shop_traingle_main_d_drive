...
import 'package:shoptrangle/data/model/body/register_model.dart';
import 'package:shoptrangle/data/model/response/base/api_response.dart';
import 'package:shoptrangle/data/model/response/base/error_response.dart';
import 'package:shoptrangle/data/model/response/response_model.dart';
import 'package:shoptrangle/data/model/response/social_login_model.dart';
...
class AuthProvider with ChangeNotifier {
  ...
  Future<ResponseModel> forgetPassword(String email) async {
    _isLoading = true;
    notifyListeners();
    ApiResponse apiResponse = await authRepo.forgetPassword(
      email,
    );
    _isLoading = false;
    notifyListeners();
