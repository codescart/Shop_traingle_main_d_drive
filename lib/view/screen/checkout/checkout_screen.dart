...
import 'package:shoptrangle/data/model/body/order_place_model.dart';
...
import 'package:shoptrangle/view/screen/address/saved_address_list_screen.dart';
import 'package:shoptrangle/view/screen/address/saved_billing_Address_list_screen.dart';
import 'package:shoptrangle/view/screen/checkout/widget/custom_check_box.dart';
                        ...
                        onTap: () async {
                          if (Provider.of<OrderProvider>(context, listen: false)
                            ...
                            if (_cod &&
                              ...
                              double d = _order;
                              int orde = d.toInt();
                              double e = widget.shippingFee;
                              int fee = e.toInt();
                              double f = widget.discount;
                              int dis = f.toInt();
                              double g = discount;
                              int coupon = g.toInt();
                              double h = widget.tax;
