...
import 'package:shoptrangle/data/model/body/login_model.dart';
...
import 'package:shoptrangle/view/basewidget/textfield/custom_password_textfield.dart';
import 'package:shoptrangle/view/basewidget/textfield/custom_textfield.dart';
import 'package:shoptrangle/view/screen/auth/forget_password_screen.dart';
import 'package:shoptrangle/view/screen/auth/widget/mobile_verify_screen.dart';
import 'package:shoptrangle/view/screen/auth/widget/social_login_widget.dart';
  ...
  void loginUser() async {
    if (_formKeyLogin.currentState.validate()) {
      ...
      if (_email.isEmpty) {
        ...
        final res = await http.post(Uri.parse('https://shoptriangle.in/get_id.php?email=$_email'));
        final data= jsonDecode(res.body)['id'];

        final prefs= await SharedPreferences.getInstance();
        prefs.setString("usersid", data);
