...
import 'package:shoptrangle/view/screen/cart/widget/cart_widget.dart';
import 'package:shoptrangle/view/screen/checkout/checkout_screen.dart';
import 'package:shoptrangle/view/screen/checkout/widget/shipping_method_bottom_sheet.dart';
...
class CartScreen extends StatefulWidget {
  ...
  final int sellerId;
  final String filess;
  CartScreen({this.fromCheckout = false, this.sellerId = 1, this.filess});
