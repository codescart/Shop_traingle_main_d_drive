...
class ColorResources {
  ...
  static Color getColombiaBlue(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xFF678cb5) : Color(0xfff53921);
  }
  static Color getLightSkyBlue(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xFFc7c7c7) : Color(0xfff53921);
  }
  ...
  static Color getImageBg(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xFF3f4347) : Color(0xfff53921);
  }
  static Color getSellerTxt(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xFF517091) : Color(0xfff53921);
  }
  ...
  static Color getFloatingBtn(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xFF49698c) : Color(0xfff53921);
  }
  ...
  static Color couponColor(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xfff53921) : Color(0xfff53921);
  }
  ...
  static const Color LIGHT_SKY_BLUE = Color(0xfff53921);
  ...
  static const Color SELLER_TXT = Color(0xfff53921);
  ...
  static const MaterialColor PRIMARY_MATERIAL = MaterialColor(0xfff53921, colorMap);
}
